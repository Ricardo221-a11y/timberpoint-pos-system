...
class Sale(Base):
 ...
 currency:Mapped[str]=mapped_column(String(8),default='USD');exchange_rate:Mapped[float]=mapped_column(Float,default=1);price_level:Mapped[str]=mapped_column(String(20),default='retail');lines:Mapped[list]=mapped_column(JSON,default=list);subtotal:Mapped[float]=mapped_column(Float,default=0);discount:Mapped[float]=mapped_column(Float,default=0);total:Mapped[float]=mapped_column(Float,default=0);amount_paid:Mapped[float]=mapped_column(Float,default=0);payment_method:Mapped[str]=mapped_column(String(40),default='cash');cost_total:Mapped[float]=mapped_column(Float,default=0);created_at:Mapped[datetime]=mapped_column(DateTime,default=now)
